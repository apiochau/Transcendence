    ...
    <main className="min-h-screen bg-white text-ink">
      <section className="mx-auto grid min-h-screen max-w-6xl content-center gap-8 px-4 py-16 md:grid-cols-[1.1fr_0.9fr] md:items-center">
        <div className="page-enter">
          <p className="mb-3 text-sm font-semibold uppercase tracking-wide text-accent">Semantic word heist</p>
          <h1 className="max-w-3xl text-4xl font-bold leading-tight md:text-6xl">Word Heist Arena</h1>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">
            Trouve le mot secret avec des indices de proximite semantique, puis prepare le braquage en duel temps reel.
          </p>
