...
export function UserProfilePage() {
  ...
  async function sendFriendRequest() {
    ...
    try {
      ...
      setActionError(getApiErrorMessage(error, 'Impossible d envoyer la demande.'));
    } finally {
      setSending(false);
    }
  }
  ...
  return (
    <section className="page-enter">
      ...
      <div className="card-surface mt-8 p-6">
        ...
        {id && <MatchHistoryList userId={id} />}

        {!isOwnProfile && profile && (
          <div className="mt-6">
            {requestSent ? (
              <p className="text-sm font-semibold text-green-700">Demande envoyee</p>
            ) : (
              <button
                type="button"
